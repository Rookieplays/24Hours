 ...
 */
public class VideoListActivity extends MainActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mailClient.setType("Help me!");
                mailClient.setData(Uri.parse("ojdevs@gmail.com"));
                mailClient.setClassName("com.google.android.gm","com.google.android.gm.ComposeActivityGmail");
                mailClient.putExtra(Intent.EXTRA_EMAIL,new String[]{"ojdevs@gmail.com"});
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            ...
            holder.mContentView.setText(mValues.get(position).video_name);
