...
public class DummyContent {
    ...
    static {
        ...
        addItem(new DummyItem("4","How to use Social in 24H","https://firebasestorage.googleapis.com/v0/b/hours-1a681.appspot.com/o/tutorial_vids%2Fsocial.mp4?alt=media&token=62bb71a0-0da3-4ef9-8077-58a744bb5138","Select one of the provided Templates or Create Your Own via the circular Button Thingy, the rest is simple"));
        addItem(new DummyItem("5","How to use Study in 24H","https://firebasestorage.googleapis.com/v0/b/hours-1a681.appspot.com/o/tutorial_vids%2Fstudy.mp4?alt=media&token=23c13f02-a883-4fc9-a806-6a9b76ea1e7c","Enter Your Subjects, select subjects to study hit the CHECK MARK AFTER EVERY DAY to save, the  blue button to save and close"));
        addItem(new DummyItem("6","How to use Quick note in 24H","https://firebasestorage.googleapis.com/v0/b/hours-1a681.appspot.com/o/tutorial_vids%2Fqplan.mp4?alt=media&token=eced8d01-8592-422f-82fe-106ee78a5d1d",""));
        addItem(new DummyItem("7","How to use Notes in 24H","https://firebasestorage.googleapis.com/v0/b/hours-1a681.appspot.com/o/tutorial_vids%2Fnotes.mp4?alt=media&token=9ff727b5-5eee-4a1f-a76f-86d74104ade7","Watch the Video!"));
        addItem(new DummyItem("8","How to use Calendar in 24H","https://firebasestorage.googleapis.com/v0/b/hours-1a681.appspot.com/o/tutorial_vids%2Fcalendar.mp4?alt=media&token=8b8894bb-3fdc-4d35-8018-82dd1257b02c","enjoy!"));
        addItem(new DummyItem("9","Home • 24H","https://firebasestorage.googleapis.com/v0/b/hours-1a681.appspot.com/o/tutorial_vids%2Fmain.mp4?alt=media&token=f62a2bed-3a98-49cf-95ec-9a8224b65015","enjoy!"));
    }
